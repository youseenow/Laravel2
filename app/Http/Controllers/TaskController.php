...
class TaskController extends Controller
{
    ...
    // 一覧用Illuminate\Database\Eloquent\Builderインスタンスの取得
    ...
    public function register(TaskRegisterPostRequest $request) {
        $datum = $request->validated(); // validate済みのデータの取得
        //$user = Auth::user(); // ユーザー情報の取得
        //$id = Auth::id(); // ユーザーIDの取得
        ...
        try {
            ...
            //var_dump($r); exit; // 確認用var_dump
        } catch(\Throwable $e) {
            echo $e->getMessage();
            exit;
        }

        // 登録完了メッセージを出すためのフラッシュデータ
